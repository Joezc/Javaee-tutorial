...
import com.xzgl.www.myrecord.service.PunishBiz;
...
public class PunishController {
    ...
    @RequestMapping("search_readonly")
    public String search_individual(Model m, String itemid) {
        if (itemid.equals("")) {
            return "redirect:/punish.do/punish_readonly.view";
        }
        Punishment r = PunishBiz.findById(itemid);
        List<Punishment> ret = new ArrayList<>();
        ret.add(r);
